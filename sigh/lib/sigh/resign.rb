...
module Sigh
  ...
  class Resign
    def run(options, args)
      ...
      ipa, signing_identity, provisioning_profiles, entitlements, version, display_name, short_version, bundle_version, new_bundle_id, new_appclip_bundle_id, use_app_entitlements, keychain_path, page_size = get_inputs(options, args)
      # ... then invoke our programmatic interface with these vars
      unless resign(ipa, signing_identity, provisioning_profiles, entitlements, version, display_name, short_version, bundle_version, new_bundle_id, new_appclip_bundle_id, use_app_entitlements, keychain_path, page_size)
        UI.user_error!("Failed to re-sign .ipa")
      end
    end

    def self.resign(ipa, signing_identity, provisioning_profiles, entitlements, version, display_name, short_version, bundle_version, new_bundle_id, new_appclip_bundle_id, use_app_entitlements, keychain_path, pagesize = nil)
      self.new.resign(ipa, signing_identity, provisioning_profiles, entitlements, version, display_name, short_version, bundle_version, new_bundle_id, new_appclip_bundle_id, use_app_entitlements, keychain_path, pagesize)
    end

    def resign(ipa, signing_identity, provisioning_profiles, entitlements, version, display_name, short_version, bundle_version, new_bundle_id, new_appclip_bundle_id, use_app_entitlements, keychain_path, pagesize = nil)
    ...
    def get_inputs(options, args)
      ...
      return ipa, signing_identity, provisioning_profiles, entitlements, version, display_name, short_version, bundle_version, new_bundle_id, new_appclip_bundle_id, use_app_entitlements, keychain_path, page_size
    end
